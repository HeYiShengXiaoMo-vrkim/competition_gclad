...
def BUPT_process():
    ...
    normalize_features = StandardScaler().fit_transform(features)
    ...
    graph.ndata['feat'] = torch.tensor(normalize_features)
    ...
    print('基于BUPT数据集的训练/验证/测试图数据集已生成！')
